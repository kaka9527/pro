...
public class ServerMQTT {
    ...
    public static final String HOST = "tcp://192.168.10.80:8899";
    //定义一个主题
//    public static final String TOPIC = "gateway/request/";
//    public static final String TOPIC = "platform/request/";
//    public static final String TOPIC = "gateway/response/";
    public static final String TOPIC = "gateway/data/";
...
//        String msg = "689999999999996891074237333700320002065016";
        // 校时
        String msg = "68350000000100688804353C32396A16";
...
//        String str = "{\"clieId\":\""+clieId+"\",\"msg\":\""+msg+"\"}";
        ...
        try{
            //for (int i = 0; i < 10; i++) {
                topic11 = client.getTopic(TOPIC+"test"+0);;
